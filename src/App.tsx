...
import { AppShell,  Burger, Button, Flex, Group, MantineProvider, NumberInput, SimpleGrid, Title } from "@mantine/core";
      ...
      >
        ...
        <AppShell.Navbar p="md">
          ...
          <SimpleGrid cols={2} mt={'md'} >
            ...
            <Button onClick={prewittEdgeDetection} >prewitt edge detection</Button>
